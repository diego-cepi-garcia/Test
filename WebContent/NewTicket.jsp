...
<form action="s" method="post">
    ...
    <div class="form-group col-auto">
      <label for="inputTicket">Monto Multa</label>
  ...
  <label class="custom-file-label" for="customFileLang">Cargar Multa</label>
    </div>
    <button type="submit" class="btn btn-primary">Agregar Multa</button>
</form>
</body>
</html>