...
<body>
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">FleetControl</a>
...
<form action="s" method="post">
    ...
    <div class="form-group col-auto">
      <label for="inputTicket">Ingresar KM</label>
      <input type="text" class="form-control" id="inputTicket" placeholder="KM" name ="ticket">
   </div>
   </div>
   <button type="submit" class="btn btn-primary">Agregar KM</button>
</form>
</body>
</html>